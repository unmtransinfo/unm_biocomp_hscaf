...
*/
@Entity
public class ScaffoldStoreEntity
{
  ...
  public ScaffoldStoreEntity(Long id,String canSmi) {
    this.id = id;
    this.canSmi = canSmi;
  }
  ...
  {
    //System.err.println("DEBUG: (ScaffoldStoreEntity.addChildId) id="+Id);
    this.childIds.add(Id);
  }
